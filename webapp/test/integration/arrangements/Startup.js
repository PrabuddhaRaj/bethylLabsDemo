sap.ui.define([
	"sap/ui/test/Opa5",
	"com/bethyllabs/SmartOrderManagement/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.bethyllabs.SmartOrderManagement.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.bethyllabs.SmartOrderManagement",
					async: true
				},
				hash: oOptions.hash,
